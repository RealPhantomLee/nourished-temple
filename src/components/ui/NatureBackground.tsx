  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
      ...
      {[...Array(10)].map((_, i) => (
        <div
          ...
          style={{
            ...
            background: i % 2 === 0 ? 'var(--color-nt-green-300)' : 'var(--color-nt-gold-light)',
      ...
      <div className="absolute inset-0 animate-mist-slow opacity-[0.06]">
        <div className="absolute top-[30%] left-[-10%] w-[120%] h-[100px] bg-gradient-to-r from-transparent via-nt-green-300 to-transparent blur-3xl" />
      </div>
